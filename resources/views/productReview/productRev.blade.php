@extends('productReview.revMaster')
@section('cont')
                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="images/free/bik.png" data-zoom-image="images/free/bik.png" alt="product image">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title">Bikaji Moong Dal</h1><!-- End .product-title -->
