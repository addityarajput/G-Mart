...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="images/free/smallog.png">
    ...
    <link rel="shortcut icon" href="images/free/smallog.png">
...
@include('productReview.prodRevFooter')
    ...
    <!-- Plugins JS File -->
    <script src="assetsfreejs/ry.minsmallogscript>
    <script src="assetsfreejs/strapsmallogmin.js"></script>
    <script src="assetsfreejs/smallogt.min.js"></script>
    <script src="assetsfreejs/rysmallogmin.js"></script>
    <script src="assetsfreejs/rfish.minsmallog></script>
    <script src="assetsfreejs/carouselsmallogjs"></script>
    <script src="assetsfreejs/strap-smallogpinner.js"></script>
    <script src="assetsfreejs/smallogm.min.js"></script>
    <script src="assetsfreejs/strap-smallogpinner.js"></script>
    <script src="assetsfreejs/ry.smallogopup.min.js"></script>
    <!-- Main JS File -->
    <script src="assetsfreejs/.smallog>
</body>
