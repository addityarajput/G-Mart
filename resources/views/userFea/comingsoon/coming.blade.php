...
<head>
    ...
    <link rel="shortcut icon" href="assets/free/smallog.png">
...
<body>
    <div class="soon">
                ...
                <div class="col-md-9 col-lg-8">
                    <div class="soon-content text-center">
                        <div class="soon-content-wrapper">
                            <img src="images/free/smallog.png" alt="Logo" class="soon-logo mx-auto">
                            ...
                            <div class="social-icons justify-content-center mb-0">
                                <a href="facebook.com" class="social-icon" target="_blank" title="Facebook"><i class="icon-facebook-f"></i></a>
        ...
        <div class="soon-bg bg-image" style="background-image: url(images/free/gro.jpg)"></div>
    ...
    $(function() {
        ...
        if ($.fn.countdown) {
            $('.coming-countdown').countdown({
                until: new Date(2022, 10, 2), // 7th month = August / Months 0 - 11 (January  - December)
                format: 'DHMS',
                padZeroes: true
            });
