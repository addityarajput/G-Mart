@extends('userFea.aboutus.aboutMaster')
@section('about')
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="images/free/ad1.jpg" alt="member photo">
                            ...
                            <div class="member-content">
                                <h3 class="member-title">Aditya Kumar singh<span>Group Leader</span></h3><!-- End .member-title -->
